...
const WomenPage = () => {
  ...
  useEffect(() =>{
    ...
    getTotal();
      ...
      const getAllProducts = async () =>{
        try {
          setLoading(true)
            const {data} = await axios.get('http://localhost:2914/api/product/women-products/women',products)
          setLoading(false)
  ...
  return (
    ...
    {/* filter side ................................... */}
    <div className='women_filter_category_box'> 
      <div className='women_filter_category_title'>
          <h1>Category</h1>
           
           {/* category......................... filtering */}
        <div className='women_category_box'>
           {
             categories?.map((c) => (
        ...
        {/* // price filter  */}
        <div className='women_price_category_box'>
           <h1>Price</h1>
