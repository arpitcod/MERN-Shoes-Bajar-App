...
const KidsPage = () => {
  ...
  useEffect(() =>{
    ...
    getTotal();
     ...
     const getAllProducts = async () =>{
      try {
        setLoading(true)
          const {data} = await axios.get('http://localhost:2914/api/product/kids-products/kids',products)
        setLoading(false)
  ...
  return (
    ...
    {/* filter side ................................... */}
    <div className='kids_filter_category_box'> 
      <div className='kids_filter_category_title'>
          <h1>Category</h1>
           
           {/* category......................... filtering */}
        <div className='kids_category_box'>
           {
             categories?.map((c) => (
        ...
        {/* // price filter  */}
        <div className='kids_price_category_box'>
           <h1>Price</h1>
